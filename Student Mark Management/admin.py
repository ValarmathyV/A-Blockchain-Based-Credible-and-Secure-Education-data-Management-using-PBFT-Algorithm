...
ttk.Button(text='STAFF DETAILS' , image=img_owner , compound=TOP ,command=owner_register).pack()
img_verify = PhotoImage(file = "Assets/verified.png").subsample(8,8)
ttk.Button(text='VERIFY STAFF FILE' , image=img_verify , compound=TOP ,command=owner_verify ).pack()
def tab3():
    user.destroy()
    import main1
